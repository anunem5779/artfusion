...
<div class="container mx-auto px-4">
    ...
    <div class="flex justify-center">
        <div class="w-full md:w-6/12 bg-[#fef6eb] shadow-md rounded-lg overflow-hidden border border-gray-300">
            ...
            <!-- Form Body -->
            <div class="p-6">
                <form action="<?php echo e(url('pictures/save')); ?>" method="post" enctype="multipart/form-data" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <!-- Category Input -->
    ...
    <div class="mt-8 bg-[#fef6eb] p-8 text-center flex justify-between items-center">
        ...
        <div class="flex space-x-4 items-center">
            <img src="<?php echo e(asset('images/valyrian_logo.png')); ?>" alt="Valyrian Visions Logo" class="w-16 h-16">
            <div>
                <p>123/Main Street</p>
                <p>Main City</p>
                <p>0123-456-789</p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sinister\Downloads\SSP Submission\SSP Submission\artfusion\artfusion\resources\views\Pictures_Folder\createNew.blade.php ENDPATH**/ ?>